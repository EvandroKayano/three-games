...
class PointerLockControlsCannon extends THREE.EventDispatcher {
  ...
  update(delta) {
    ...
    const forwardVelocity = (this.moveForward==true ? 1 : 0) + (this.moveBackward==true ? -1 : 0)
    const strafeVelocity = (this.moveLeft==true ? 1 : 0) + (this.moveRight==true ? -1 : 0)
    ...
    if(strafeVelocity == 0 && forwardVelocity == 0) {
      ...
      this.velocity.z += -this.velocity.z/10;
    }
